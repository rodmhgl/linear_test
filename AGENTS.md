...
A Go CLI tool (`ldctl`) for managing bookmarks in a LinkDing instance.

## Technology Stack

- Language: Go 1.25 (Released August 2025)
- CLI Framework: cobra
...
2. Config via `~/.config/ldctl/config.yaml` or environment variables
...
go mod init github.com/rodmhgl/ldctl
go mod tidy
